...
class ButtonMixin:
    ...
    def button(
        ...
        *,  # keyword-only arguments:
        ...
        icon : str or None
            ...
            - A single-character emoji. For example, you can set ``icon="š¨"``
        ...
        **Example 2: Add icons to your button**
        ...
        >>> if middle.button("Emoji button", icon="˜ƒ", width="stretch"):
    ...
    def page_link(
        ...
        *,
        ...
        >>> st.page_link("http://www.google.com", label="Google", icon="ŒŽ")
